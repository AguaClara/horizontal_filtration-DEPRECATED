...
1. Get a polycarbonate box (width and length of 20.3cm, height of 17.5cm), available at the AguaClara lab, with a previously inserted push-to-connect connector on one side of the box approximately 2 centimeters above the base. **[This is not necessarily available all the time. It may have been true for you that it was available, but not necessarily in the future. You should probably separate this into two steps. Also, this is very informal writing. Change to formal.]**
2. Using a sheet of PVC, cut two sheets measuring 10.5 cm x 19.5 cm x 0.5 cm using the bandsaw. **[It says using one sheet, cut two. Could you say cut a sheet into two instead so it's clearer?]**
3. Weld the shelves on at a 55 degree angle, as the original design recommended. Weld the first sheet so that both the wall and base are connected and the  second sheet approximately 2.5 cm above the first.
4. Cut a 12 cm x 80 cm rectangular slit above each shelf for water flow.
5. Drill holes approximately 0.5 cm in diameter along 16.5 cm of two 2.5 cm diameter pipes. The pipes were 51 cm in length when including caps.
...
Given the time that would be needed to refabricate and ensure the apparatus’s watertightness, it was determined that it would be more efficient to restart the apparatus design with a 3D printed design. Additionally, with a 3D printed design, the apparatus could easily be scaled down and adjusted as needed. **[To keep the parts of your report about the failed welded box and the new 3D printing idea, refrain from talking about future plans in this section.]**
